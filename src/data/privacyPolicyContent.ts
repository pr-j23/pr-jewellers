...
export interface PrivacyPolicyContent {
  ...
  collectingData: {
    ...
    usageDataParagraphs: string[];
    trackingIntro: string;
    trackingBullets: Array<{ title: string; text: string }>;
    cookiesPersistenceText: string;
    consentText: string;
    cookieTypes: CookieInfo[];
    cookiesPolicyNote: string;
  };
  useOfData: {
    purposes: Array<{ label: string; text: string }>;
    sharingSituations: Array<{ label: string; text: string }>;
  };
  retention: {
    p1: string;
    p2: string;
    categories: Array<{ title: string; items: string[] }>;
    additionalRetentionIntro: string;
    reasons: string[];
    requestNote: string;
    deletionIntro: string;
    deletionProcedures: Array<{ label: string; text: string }>;
  };
  transfer: string[];
  deleteData: string[];
  disclosure: {
...
export const PRIVACY_POLICY_CONTENT: PrivacyPolicyContent = {
  ...
  intro: {
    ...
    generatorLinkText: 'Privacy Policy Generator',
    generatorUrl: 'https://www.termsfeed.com/privacy-policy-generator/',
    p2AfterLink: '.',
  },
  definitions: {
    interpretation:
    ...
    items: [
      ...
      },
      {
        term: 'Company',
        description:
          '(referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to Pavan Jewellers, 21-3-88, Chelapuara, Ghansi Bazar, Hyderabad 500 002.',
      },
      {
        term: 'Cookies',
        description:
      ...
      {
        term: 'Country',
        description: 'refers to: Telangana, India',
      },
      {
        term: 'Device',
        description:
      ...
      {
        term: 'Website',
        description: 'refers to Pavan Jewellers, accessible from https://pavanjewellers.in/.',
      },
      {
        term: 'You',
        description:
  ...
  collectingData: {
    ...
    trackingBullets: [
      {
        ...
        text: 'A cookie is a small file placed on Your Device. You can instruct Your browser to refuse all Cookies or to indicate when a Cookie is being sent. However, if You do not accept Cookies, You may not be able to use some parts of our Service.',
      },
      {
        title: 'Web Beacons.',
    ...
    cookiesPersistenceText:
      'Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser.',
    consentText:
      'Where required by law, we use non-essential cookies (such as analytics, advertising, and remarketing cookies) only with Your consent. You can withdraw or change Your consent at any time using Our cookie preferences tool (if available) or through Your browser or device settings. Withdrawing consent does not affect the lawfulness of processing based on consent before its withdrawal.',
    cookieTypes: [
      {
  ...
  useOfData: {
    purposes: [
      ...
      {
        label: 'For the performance of a contract:',
      ...
      {
        label: 'To provide You',
        text: 'with news, special offers, and general information about other goods, services and events which We offer that are similar to those that you have already purchased or inquired about unless You have opted not to receive such information.',
      },
      {
    ...
    sharingSituations: [
      {
        ...
        text: 'We may share Your Personal Data with Service Providers to monitor and analyze the use of our Service, to contact You.',
      },
      {
        label: 'For business transfers:',
        text: 'We may share or transfer Your Personal Data in connection with, or during negotiations of, any merger, sale of Company assets, financing, or acquisition of all or a portion of Our business to another company.',
      },
      {
        label: 'With Affiliates:',
        text: 'We may share Your Personal Data with Our affiliates, in which case we will require those affiliates to honor this Privacy Policy. Affiliates include Our parent company and any other subsidiaries, joint venture partners or other companies that We control or that are under common control with Us.',
      },
      {
        label: 'With business partners:',
        text: 'We may share Your Personal Data with Our business partners to offer You certain products, services or promotions.',
      },
      {
        label: 'With other users:',
        text: 'If Our Service offers public areas, when You share Personal Data or otherwise interact in the public areas with other users, such information may be viewed by all users and may be publicly distributed outside.',
      },
      {
        label: 'With Your consent:',
        text: 'We may disclose Your Personal Data for any other purpose with Your consent.',
      },
    ],
  },
  retention: {
    p1: 'The Company will retain Your Personal Data only for as long as is necessary for the purposes set out in this Privacy Policy. We will retain and use Your Personal Data to the extent necessary to comply with our legal obligations (for example, if We are required to retain Your data to comply with applicable laws), resolve disputes, and enforce our legal agreements and policies.',
    p2: 'Where possible, We apply shorter retention periods and/or reduce identifiability by deleting, aggregating, or anonymizing data. Unless otherwise stated, the retention periods below are maximum periods ("up to") and We may delete or anonymize data sooner when it is no longer needed for the relevant purpose. We apply different retention periods to different categories of Personal Data based on the purpose of processing and legal obligations:',
    categories: [
      {
    ...
    deletionProcedures: [
      {
        label: 'Deletion:',
        text: 'Personal Data is removed from Our systems and no longer actively processed.',
      },
      {
        label: 'Backup retention:',
        text: 'Residual copies may remain in encrypted backups for a limited period consistent with our backup retention schedule and are not restored except where necessary for security, disaster recovery, or legal compliance.',
      },
      {
        label: 'Anonymization:',
        text: 'In some cases, We convert Personal Data into anonymous statistical data that cannot be linked back to You. This anonymized data may be retained indefinitely for research and analytics.',
      },
    ],
  },
  transfer: [
  ...
  contactUs: {
    ...
    websiteUrl: 'https://pavanjewellers.in/',
    phone: '6304170035',
  },
};
