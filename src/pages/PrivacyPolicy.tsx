        ...
        <div className="space-y-8 text-gray-700 leading-relaxed">
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-3">
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to Pavan Jewellers, accessible from{' '}
                  <a
                    href="https://pavanjewellers.in/"
                    rel="external nofollow noopener"
                    target="_blank"
                    className="text-purple-700 hover:underline"
                  >
                    https://pavanjewellers.in/
                  </a>
                  .
                </p>
              </li>
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              browser or device settings. Withdrawing consent does not affect the lawfulness of
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-3">
              ...
              <li>
                <strong>With other users:</strong> If Our Service offers public areas, when You
                share Personal Data or otherwise interact in the public areas with other users, such
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <p>By email: contact@pavanjewellers.in</p>
              </li>
              <li>
                <p>
